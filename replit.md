...
- **2026-02-26**: Refined Violation 3 logic: (1) Removed "≥10h total" condition — now only checks longest rest period ≥6h. (2) Made Violation 3 conditional on Violation 1 — only appears when anyPeriodRest24hr < 10h (always `[1, 3]`, never `[3]` alone). Files: `timelineCalculations.ts`, `RHRecordingForm.tsx`.
