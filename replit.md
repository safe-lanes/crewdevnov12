...
- **2026-02-26**: Changed "Hours of Rest in any 7 Day period" from rolling 168-hour window to simple sum of last 7 consecutive days' "RH in 24 Hr" (daily recorded rest). For days 1–6 of the month, uses previous month's daily rest values; if unavailable, assumes 24h rest per missing day. Work in 7 days = 168 − rest7day. Removed `calculateTimelineRollingMetrics` import (no longer needed). Files: `RHRecordingForm.tsx`.
