...
const PartDComponent: React.FC<PartDProps> = ({
  ...
  return (
    <fieldset disabled={lockSection} className="min-w-0 border-0 p-0 m-0" data-testid="fieldset-part-d-lock">
          ...
          <div className="border rounded-lg overflow-hidden">
            <table className="w-full">
                  ...
                  <Fragment key={assessment.id}>
                    <tr className="border-t">
                      ...
                      <td className="text-[#4f5863] text-[13px] font-normal py-2 px-4">
                        <Select value={assessment.effectiveness} onValueChange={(value) => updateBehaviouralAssessment(assessment.id, "effectiveness", value)} disabled={lockSection}>
                      ...
                      <td className="text-[#4f5863] text-[13px] font-normal py-2 px-4">
                        <div className="flex gap-2 justify-center">
                          <Button type="button" variant="ghost" size="icon" className="h-6 w-6" onClick={() => setBehaviouralComments(prev => ({ ...prev, [assessment.id]: prev[assessment.id] || "" }))}>
                        ...
                        <td colSpan={4} className="p-3">
                          {editingBehaviouralComment === assessment.id ? (
                            ...
                            <div className="flex justify-between items-start">
                              <div className="flex-1 text-blue-600 italic cursor-pointer p-2 rounded hover:bg-gray-50 text-[13px]" onClick={() => setEditingBehaviouralComment(assessment.id)}>
              ...
              <tfoot className="bg-gray-50">
                <tr>
                  <td colSpan={3} className="text-right font-medium py-3 px-4">Behavioural Section Score:</td>
...
export const PartD = memo(PartDComponent);
