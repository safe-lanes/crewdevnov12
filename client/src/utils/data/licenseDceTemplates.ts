...
export const LICENSE_DCE_TEMPLATES: LicenseTemplate[] = [
  ...
  { id: 'LIC008', name: 'COC Chief Mate', abbr: 'COC_DC', requirement: 'STCW II/2' },
  { id: 'LIC009', name: 'COC OIC Nav Watch', abbr: 'COC_DW', requirement: 'STCW II/1' },
  { id: 'LIC010', name: 'COC Chief Engineer', abbr: 'COC_EC', requirement: 'STCW III/2' },
  { id: 'LIC011', name: 'COC 2nd Engineer', abbr: 'COC_ES', requirement: 'STCW III/2' },
  { id: 'LIC012', name: 'COC OIC Eng Watch', abbr: 'COC_EW', requirement: 'STCW III/1' },
  { id: 'LIC013', name: 'COC ETO', abbr: 'COC_EO', requirement: 'STCW III/6' },
  
  // COP Certificates
  { id: 'LIC014', name: 'COP Deck Rating (AB)', abbr: 'COP_DRA', requirement: 'STCW II/5' },
  { id: 'LIC015', name: 'COP Deck Rating (OS)', abbr: 'COP_DRB', requirement: 'STCW II/4' },
  { id: 'LIC016', name: 'COP Engine Rating (ABE)', abbr: 'COP_ERA', requirement: 'STCW III/5' },
  { id: 'LIC017', name: 'COP Engine Rating', abbr: 'COP_ERB', requirement: 'STCW III/4' },
];
