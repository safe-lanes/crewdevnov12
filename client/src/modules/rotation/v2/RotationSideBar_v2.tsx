...
export function RotationSideBar_v2({ selectedRotationPage, setSelectedRotationPage, allowedPages }: RotationSideBarV2Props) {
...
export default RotationSideBar_v2;
