...
FROM (VALUES
  ...
  ('R004', '3rd Officer_1',      'A00103', '2025-06-05', '2025-11-05', 5),
  ('R004', '3rd Officer_2',      'A00104', '2025-08-16', '2026-04-16', 8),
  ...
  ('R015', 'AB_3',               'A00111', '2025-07-31', '2026-03-31', 8),
  ('R015', 'AB_2',               'A00112', '2025-07-09', '2026-02-09', 7),
  ('R015', 'AB_1',               'A00113', '2025-05-08', '2026-02-08', 9),
  ('R016', 'OS_2',               'A00114', '2025-08-22', '2026-05-22', 9),
  ('R016', 'OS_3',               'A00115', '2025-09-29', '2026-03-29', 6),
  ('R016', 'OS_1',               'A00116', '2025-05-22', '2026-01-22', 8),
  ('R018', 'Fitter_1',           'A00117', '2025-06-12', '2026-02-12', 8),
  ('R021', 'Oiler_1',            'A00118', '2025-04-15', '2025-11-15', 7),
  ('R021', 'Oiler_3',            'A00119', '2025-08-16', '2026-05-16', 9),
  ('R021', 'Oiler_2',            'A00120', '2025-07-01', '2026-01-01', 6),
...
FROM (VALUES
  ...
  ('R004', '3rd Officer_1',      'A00203', '2025-06-01', '2025-12-01', 6),
  ('R004', '3rd Officer_2',      'A00204', '2025-06-15', '2025-12-15', 6),
  ...
  ('R015', 'AB_1',               'A00211', '2025-04-01', '2026-02-01', 10),
  ('R015', 'AB_2',               'A00212', '2025-05-01', '2026-02-01', 9),
  ('R015', 'AB_3',               'A00213', '2025-06-01', '2026-02-01', 8),
  ('R016', 'OS_2',               'A00214', '2025-03-15', '2025-12-15', 9),
  ('R016', 'OS_1',               'A00215', '2025-03-01', '2025-12-01', 9),
  ('R016', 'OS_3',               'A00216', '2025-04-15', '2026-01-15', 9),
  ('R018', 'Fitter_1',           'A00217', '2025-07-01', '2026-02-01', 7),
  ('R021', 'Oiler_1',            'A00218', '2025-04-01', '2026-02-01', 10),
  ('R021', 'Oiler_2',            'A00219', '2025-05-01', '2026-02-01', 9),
  ('R021', 'Oiler_3',            'A00220', '2025-08-01', '2026-04-01', 8),
