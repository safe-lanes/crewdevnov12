...
- **Vessel Master**: Master data → `/api/v2/masters/vessels` 
- **License Master**: Master data → `/api/v2/masters/licenses-dce`
- **Vessel Types**: Master data → `/api/v2/masters/vessel-types` 
